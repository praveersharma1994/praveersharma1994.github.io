<%@ Page Title="Add Banner" Language="C#" MasterPageFile="~/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="gallerybanner.aspx.cs" Inherits="admin_gallerybanner" %>
            ...
            <div class="scrollable wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="page-heading">
                            <h1>Home Gallery Banner (Website)</h1>
                        </div>
                    </div>
                    <!--col-md-12 end-->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <!--box-info start-->
                        <div class="box-info">
                            <h3>Home Gallery Banner List</h3>
                            <hr>
                    ...
                    <div class="col-md-5">
                        <!--box-info start-->
                        <div class="box-info">
                            <h3>Add / Edit Home Gallery Banner</h3>
                            <hr>
                            <!--form-horizontal row-border start-->
                            <div class="form-horizontal row-border">
                                <!--form-group start-->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <%--<asp:RequiredFieldValidator ControlToValidate="txturl" Font-Size="11px" ForeColor="Red" Text="URL is required" SetFocusOnError="true" runat="server" ID="req" Display="Dynamic" ValidationGroup="cat"></asp:RequiredFieldValidator>--%>
                                    </div>
                                </div>
                                <!--form-group end-->
                                <!--form-group start-->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Image(250 X 360)</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <div class="btn-toolbar" id="divnotadd" runat="server">
                                        <asp:Button runat="server" ID="btnSave" class="btn-primary btn btn2" OnClick="btnSave_Click" Text="Submit" />
