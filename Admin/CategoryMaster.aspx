                                            ...
                                            <asp:GridView AutoGenerateColumns="false" OnRowCommand="grdList_RowCommand" EmptyDataText="No Record Found?" EmptyDataRowStyle-ForeColor="Red" OnPageIndexChanging="grdList_PageIndexChanging" PageSize="10" AllowPaging="true" runat="server" ID="grdList" CssClass="display table table-bordered table-striped dataTable" aria-describedby="dynamic-table_info">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Img">
                                                        <ItemTemplate>
                                                            <img src="<%#"../upload/category/"+Eval("CategoryImg")%>" onerror="this.src='../images/noimage.JPG'" style="max-height: 60px; max-width: 60px;" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button runat="server" ID="btnEdit" Text="Edit" CommandName="edt" CommandArgument='<%#Eval("CategoryId") %>' CssClass="btn btn2 btn-primary" />
                                                            <asp:Button runat="server" ID="btnDelete" OnClientClick="return confirm('Are you sure to delete?')" Text="Delete" CommandName="del" CommandArgument='<%#Eval("CategoryId") %>' CssClass="btn btn2 btn-danger" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                            ...
                            <div class="form-horizontal row-border">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ControlToValidate="txtCategory" Font-Size="11px" Text="Category Name is required" SetFocusOnError="true" runat="server" ID="req" Display="Dynamic" ValidationGroup="cat"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <!--form-group end-->
                                <!--form-group start-->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Image (400 X 400)</label>
                                    <div class="col-sm-9">
