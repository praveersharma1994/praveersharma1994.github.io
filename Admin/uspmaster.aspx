<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="uspmaster.aspx.cs" Inherits="uspmaster" %>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S No">
                                                      ...
                                                      <asp:TemplateField HeaderText="Img">
                                                        <ItemTemplate>
                                                            <img src="<%#"../upload/usp/"+Eval("IconImageName")%>" onerror="this.src='../images/noimage.JPG'" style="max-height: 60px; max-width: 60px;" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button runat="server" ID="btnEdit" Text="Edit" CommandName="edt" CommandArgument='<%#Eval("USPId") %>' CssClass="btn btn2 btn-primary" />
                            ...
                            <div class="form-horizontal row-border">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ControlToValidate="txttitle" Font-Size="11px" Text="Title is required" SetFocusOnError="true" runat="server" ID="req" Display="Dynamic" ValidationGroup="cat"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label">Sub Title*</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="txtsubtitle" class="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ControlToValidate="txtsubtitle" Font-Size="11px" Text="Subtitle is required" SetFocusOnError="true" runat="server" ID="RequiredFieldValidator1" Display="Dynamic" ValidationGroup="cat"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <!--form-group start-->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Image (32X32 -.png)</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="txtDisplayOrder" onkeypress="return digits(this,event,false,false)" class="form-control" Text="1"></asp:TextBox>
